...
class Downloader extends AsyncTask<Object, Integer, ArrayList<Float>>{
	
	MainActivity callerActivity;
	
	ArrayList<Float> getValue() throws IOException{
		try{
			return loadXmlFromNetwork(MainActivity.BASE_URL);
	...
	protected ArrayList<Float> doInBackground(Object... arg0){
		try{
			callerActivity = (MainActivity) arg0[1];
			ArrayList<Float> airtc = getValue();
			return airtc;
		} catch (IOException e){				
...
/*		TextView tv = (TextView)findViewById(R.id.textView1);
	...
	private ArrayList<Float> loadXmlFromNetwork(String urlString) throws XmlPullParserException, IOException {
